...
INSERT INTO FLAVOR_T(PRODUCT_ID, FLAV_NAME_ID, DESCREPTION, VENDOR_ID)
...
INSERT INTO TEA_BLEND_T(PRODUCT_ID, BLEND_NAME_ID, DESCREPTION, RECO_BREW_TEMP_F, RECO_BREW_TIME_SEC, RECO_POT_MATERIAL)
...
INSERT INTO TEA_SET_T(PRODUCT_ID, SET_NAME_ID, MAKER, STYLE, MATERIAL, NUM_CUPS, DESCREPTION, VENDOR_ID)
...
INSERT INTO TEA_POT_T(PRODUCT_ID, POT_MODEL_ID, MAKER, STYLE, MATERIAL, DESCREPTION, VENDOR_ID)
...
INSERT INTO MUG_T (PRODUCT_ID, MUG_MODEL_ID, MAKER, MATERIAL, DESCREPTION, VENDOR_ID)
...
CREATE TRIGGER get_insert AFTER INSERT 
ON INVENTORY_T
